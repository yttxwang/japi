...
class KLogger
{
     ...
     * @var string
     */
    private $_logFileDir        = null;
    private $_logFilePath       = null;
    private $_issetLogFilePath  = false;
     ...
     * 2015/11/30 by 刘祥敏
     */
    public function setLogFilePath($numCompanyID)
    {
        if($this->_issetLogFilePath === false){
            $this->_logFilePath = $this->_logFileDir
                . DIRECTORY_SEPARATOR
                . 'log_'.$numCompanyID.'_'
                . date('Y-m-d')
                . '.txt';
